...
public record RequestBrokerSignUp(
...
//        @Size(min = 8, message = "비밀번호는 최소 8자 이상이어야 합니다.")
        ...
        @NotBlank(message = "중개사 이름은 필수 항목입니다.")
        @Size(max = 45, message = "중개사 이름은 최대 45자까지 입력할 수 있습니다.")
        String officeName,
        ...
        @Size(max = 45, message = "주소는 최대 45자까지 입력할 수 있습니다.")
        String address,

        @NotBlank(message = "자격증 번호는 필수 항목입니다.")
        @Size(max = 45, message = "자격증 번호는 최대 45자까지 입력할 수 있습니다.")
        String licenseNum,
